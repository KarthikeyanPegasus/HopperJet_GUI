...
class IpSpoofDetection extends StatefulWidget {
  const IpSpoofDetection({Key? key}) : super(key: key);

  @override
  State<IpSpoofDetection> createState() => _IpSpoofDetectionState();
}

class _IpSpoofDetectionState extends State<IpSpoofDetection> {
  bool isfound = false;
  String interface = "";
